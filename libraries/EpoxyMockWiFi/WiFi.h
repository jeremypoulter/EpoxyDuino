...
//-----------------------------------------------------------------------------
// Unified enum containing both legacy ESP8266 events and ESP32 ARDUINO_EVENT_* values.
typedef enum {
#if defined(ESP8266)
    // ESP8266-compatible events
...
public:
    ...
    void onEvent(WiFiEventCb cbEvent, WiFiEvent_t event = ARDUINO_EVENT_MAX);
